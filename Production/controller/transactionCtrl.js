...
const API = require('../config/kucoinSdk')
...
const generateCryptoAddress = async (req, res, next)=>{
    const getBtcAddress = await API.rest.User.Deposit.getDepositAddressV2('BTC');
    console.log(getBtcAddress);
    res.send(getBtcAddress)
}

module.exports = {sendAsset, getAllTransaction, demoAssetRequest, exchangeAsset, generateCryptoAddress};